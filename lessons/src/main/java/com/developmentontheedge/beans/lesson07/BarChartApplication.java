package com.developmentontheedge.beans.lesson07;
...
import com.developmentontheedge.beans.lesson07.barchart.BarChart;
import com.developmentontheedge.beans.lesson07.barchart.Column;
...
public class BarChartApplication extends JFrame
{
    ...
    public void initializePropertyInspector( BarChart bean )
    {
        ...
        // for better view collapse array properties
        propertyInspector.collapseProperty("columns");
        propertyInspector.collapseProperty("columns1");
        propertyInspector.collapseProperty("columns2");
    }
