...
public class JTreeTable extends JTable
    ...
    public JTreeTable( TreeModel treeModel, TableModel tableModel )
        {
        super();
        init(
            new DefaultTreeTableModel( treeModel, tableModel ) );
        }
    ...
    public class TreeTableCellEditor extends AbstractCellEditor implements TableCellEditor
        ...
        /**
         * Overridden to return false, and if the event is a mouse event it is forwarded to the tree.<p>
    ...
    class ListToTreeSelectionModelWrapper extends DefaultTreeSelectionModel
         ...
         * listens for changes to this model and updates the selected paths accordingly.
         */
         ...
         * and message super. This is the only place DefaultTreeSelectionModel alters the ListSelectionModel.
         */
        @Override
         ...
         * reset the selected paths from the selected rows in the list selection model.
         */
