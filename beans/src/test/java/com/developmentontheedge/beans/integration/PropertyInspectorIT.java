...
public class PropertyInspectorIT extends TestCase
{

    protected static JFrame frame = null;
    protected static PropertyInspector insp = null; 

    public PropertyInspectorIT(String name)
    {
        super(name);
   ...
   if( frame == null )
    ...
    {
    TestCase.assertTrue( "failed to create PropertyInspector", insp != null );
    }
...
*/
    public void testDisplayFromArray()
    {
        ...
        TestCase.assertTrue( "Array is not set",
      JOptionPane.showConfirmDialog( insp, "Does it show?" ) ==
      JOptionPane.YES_OPTION  );
    }
    ...
    public static Test suite()
    {
        ...
        suite.addTest(new PropertyInspectorIT("testCreate"));
...
//        suite.addTest(new PropertyInspectorTest("testDisplayFromJar"));
        suite.addTest(new PropertyInspectorIT("testDisplayFromArray"));
