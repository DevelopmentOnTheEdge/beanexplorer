...
public class TabularPropertyInspectorIT extends TestCase
{

    protected static JFrame frame = null;
    protected static TabularPropertyInspector insp = null;

    public TabularPropertyInspectorIT(String name )
    {
        super( name );
    ...
    {
        TestCase.assertTrue( "failed to create TabularPropertyInspector", insp != null );
    }
...
*/
    ...
    public static Test suite()
    {
        ...
        {
            suite.addTest(
                new TabularPropertyInspectorIT( "testCreate" ) );
//            suite.addTest(
